...
extern char _binary_wasmjit_code_start; /* defined in the linker script */
extern char _binary_wasmjit_code_end;
#define __WASMJIT_CODE_BASE ((void*)&_binary_wasmjit_code_start)
#define __WASMJIT_CODE_END ((void*)&_binary_wasmjit_code_end)
