...
int
emit_add_ri(struct SizedBuffer* output,
            sgxwasm_register_t dst,
            int64_t src,
            sgxwasm_valtype_t type)
{
...
int
emit_ror_r(struct SizedBuffer* output,
           sgxwasm_register_t dst,
           sgxwasm_valtype_t type)
{
...
int
emit_ror_ri(struct SizedBuffer* output,
            sgxwasm_register_t dst,
            int8_t shift_amount,
            sgxwasm_valtype_t type)
{
...
int
emit_rol_r(struct SizedBuffer* output,
           sgxwasm_register_t dst,
           sgxwasm_valtype_t type)
{
...
int
emit_rol_ri(struct SizedBuffer* output,
            sgxwasm_register_t dst,
            int8_t shift_amount,
            sgxwasm_valtype_t type)
{
                      ...
                      sgxwasm_valtype_t type)
{
  ...
  count += emit_jcc(output, COND_GT_U, &lhs_above_rhs, Near); // CF = 0 && ZF = 0
...
int emit_popcnt_rr(struct SizedBuffer* output,
                   sgxwasm_register_t dst,
                   sgxwasm_register_t src,
                   sgxwasm_valtype_t type)
{
...
int emit_tzcnt_rr(struct SizedBuffer* output,
                   sgxwasm_register_t dst,
                   sgxwasm_register_t src,
                   sgxwasm_valtype_t type)
{
...
int emit_lzcnt_rr(struct SizedBuffer* output,
                   sgxwasm_register_t dst,
                   sgxwasm_register_t src,
                   sgxwasm_valtype_t type)
{
                           ...
                           label_t* trap)
{
  ...
  count += convert_float_to_int_and_back(output,
                                dst,
                                dst_type,
                                signed_or_unsigned,
                                rounded,
                     ...
                     label_t* trap)
{
  ...
  switch (opcode) {
    ...
    case OPCODE_I32_TRUNC_S_F32:
      count += emit_truncate_float_to_int(
