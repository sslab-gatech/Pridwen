...
emit_add_rr(struct SizedBuffer*,
            ...
            sgxwasm_valtype_t);
int
emit_add_ri(struct SizedBuffer*,
            sgxwasm_register_t,
            int64_t,
            sgxwasm_valtype_t);
int
...
int
emit_ror_r(struct SizedBuffer*, sgxwasm_register_t, sgxwasm_valtype_t);
int
emit_ror_ri(struct SizedBuffer*, sgxwasm_register_t, int8_t, sgxwasm_valtype_t);
int
emit_rol_r(struct SizedBuffer*, sgxwasm_register_t, sgxwasm_valtype_t);
int
emit_rol_ri(struct SizedBuffer*, sgxwasm_register_t, int8_t, sgxwasm_valtype_t);
void
...
int
emit_std(struct SizedBuffer*);
int
emit_cld(struct SizedBuffer*);
int
emit_rep_stosq(struct SizedBuffer*);
int
emit_pushfd(struct SizedBuffer*);
int
emit_popfd(struct SizedBuffer*);

int emit_tzcnt_rr(struct SizedBuffer*,
                   sgxwasm_register_t,
                   sgxwasm_register_t,
                   sgxwasm_valtype_t);
int emit_lzcnt_rr(struct SizedBuffer*,
                   sgxwasm_register_t,
                   sgxwasm_register_t,
                   sgxwasm_valtype_t);
int emit_popcnt_rr(struct SizedBuffer*,
                   sgxwasm_register_t,
                   sgxwasm_register_t,
                   sgxwasm_valtype_t);
