...
void
R0(uint32_t v, uint32_t* w, uint32_t x, uint32_t y, uint32_t *z, uint32_t i, CHAR64LONG16* block)
{
  *z += ((*w & (x^y))^y)+blk0(i)+0x5A827999 + rol(v,5);
  *w = rol(*w,30);
}
void
R1(uint32_t v, uint32_t* w, uint32_t x, uint32_t y, uint32_t *z, uint32_t i, CHAR64LONG16* block)
{
  *z += ((*w & (x^y))^y)+blk(i)+0x5A827999 + rol(v,5);
  *w = rol(*w,30);
}
void
R2(uint32_t v, uint32_t* w, uint32_t x, uint32_t y, uint32_t *z, uint32_t i, CHAR64LONG16* block)
{
  *z += (*w^x^y)+blk(i)+0x6ED9EBA1+rol(v,5);
  *w = rol(*w,30);
}
void
R3(uint32_t v, uint32_t* w, uint32_t x, uint32_t y, uint32_t *z, uint32_t i, CHAR64LONG16* block)
{
  *z += (((*w|x)&y)|(*w&x))+blk(i)+0x8F1BBCDC+rol(v,5);
  *w = rol(*w,30);
}
void
R4(uint32_t v, uint32_t* w, uint32_t x, uint32_t y, uint32_t *z, uint32_t i, CHAR64LONG16* block)
{
